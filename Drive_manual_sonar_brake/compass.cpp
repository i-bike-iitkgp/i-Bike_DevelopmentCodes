...
float compass_x_avg=0,compass_y_avg=0,compass_z_avg=0;
...
void compass_offset_calibration(int select){
 ...
 // Configuring the Control register for Positive Bais mode, self test
...
//  }
  ...
  {
    compass_read_XYZdata();
    compass_x_avg += compass_x;
    compass_y_avg += compass_y;
    compass_z_avg += compass_z;
  }

  compass_x_avg = compass_x/8.0;
  compass_y_avg = compass_y/8.0;
  compass_z_avg = compass_z/8.0;

  compass_x_scalled=compass_x_avg*compass_gain_fact;
  compass_y_scalled=compass_y_avg*compass_gain_fact;
  compass_z_scalled=compass_z_avg*compass_gain_fact;
